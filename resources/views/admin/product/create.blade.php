<x-app-layout>
    <div class="flex flex-col justify-center items-center">
        ...
        <form class="max-w-xl w-full mt-3"  enctype="multipart/form-data">
            <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <button type="submit"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center mt-3 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
        </form>
    </div>
</x-app-layout>
