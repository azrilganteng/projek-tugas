<x-app-layout>
    <div class="flex flex-col justify-center items-center">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 shadow-lg rounded-lg p-8 mt-20">
                <h1 class="text-2xl text-white font-extrabold mb-6 text-center">TARUH PERASAAN ANDA DI SINI</h1>
    ...
    <form action="{{ route('import') }}" method="POST" enctype="multipart/form-data" class="mb-4">
        @csrf
        <input type="file" name="file" required class="block mb-10 bg-gray-500">
